...
\begin{figure}[ht]
\centering
	\includegraphics[width=.5\textwidth]{Img_MsgQueue.jpg}
...
\end{document}
inhar as mensagens de um para o outro. Desta forma, o dispositivo de encaminhamento se torna o ponto estável da rede, ao qual cada componente pode se conectar.
